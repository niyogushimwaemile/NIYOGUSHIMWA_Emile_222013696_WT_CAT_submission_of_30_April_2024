...
<body class="grey lighten-3">
  ...
  <main class="pt-5 mx-lg-3">
  	<div class="container-fluid mt-5 mb-3">
  		...
  		<div class="card mb-4 wow fadeIn" onload='graph2()'>  
				        ...
				        <div class=col-md-9 mb-4>  
				 		...
				 		<div class="col-md-3 mb-4"> 
				          ...
				          <div class="card mb-4">  
				            ...
				            <?php			
									$stm1 = mysqli_query($con, "SELECT COUNT(*) AS pending FROM permissions WHERE Status='Pending'");
									$stm2 = mysqli_query($con, "SELECT COUNT(*) AS approved FROM permissions WHERE Status='Accepted'");
									$stm3 = mysqli_query($con, "SELECT COUNT(*) AS rejected FROM permissions WHERE Status='Denied'");
									$stm4 = mysqli_query($con, "SELECT COUNT(*) AS terminate FROM permissions WHERE Status='Terminated'");
									$stm5 = mysqli_query($con, "SELECT COUNT(*) AS perms FROM permissions");
				            ...
				            <!-- List group links --> 
				              <div class="list-group list-group-flush"> 
				                ...
				                <a href='Permissions new.php' class="list-group-item list-group-item-action waves-effect">Pending 
